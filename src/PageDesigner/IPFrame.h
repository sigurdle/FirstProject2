...
//	public IOleCommandTarget,
	public CUIManagerImpl<CIPFrame>,
	public CUIOleIPFrameImpl<CIPFrame, IUIFrame>
...
*/
	typedef CUIOleIPFrameImpl<CIPFrame, IUIFrame> baseClass;

BEGIN_MSG_MAP(CIPFrame)
