// ASEditCtlsMod.cpp : Implementation of DLL Exports.


// Note: Proxy/Stub Information
//      To build a separate proxy/stub DLL, 
//      run nmake -f ASEditCtlsModps.mk in the project directory.
...
//OBJECT_ENTRY(CLSID_ASGraphCtl, CASGraphCtl)
END_OBJECT_MAP()
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID /*lpReserved*/)
{
    ...
    {
        _Module.Init(ObjectMap, hInstance);//, &LIBID_ASEDITCTLSMODLib);
