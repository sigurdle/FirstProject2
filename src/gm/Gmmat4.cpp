...
/*
gmVector3t<float> gmMatrix4::transform(const gmVector3t<float>& v) const
{
...
gmVector3t<double> gmMatrix4::transform(const gmVector3t<double>& v) const
{
  return gmVector3t<double>(
    v[0] * m_[0][0] + v[1] * m_[1][0] + v[2] * m_[2][0] + m_[3][0],
    v[0] * m_[0][1] + v[1] * m_[1][1] + v[2] * m_[2][1] + m_[3][1],
    v[0] * m_[0][2] + v[1] * m_[1][2] + v[2] * m_[2][2] + m_[3][2]);
}
...
gmMatrix4 gmMatrix4::rotate(double angle, const gmVector3t<float>& axis)
{
  gmMatrix4 m_;
...
gmMatrix4 gmMatrix4::rotate(double angle, const gmVector3t<double>& axis)
{
  gmMatrix4 m_;
  double length = axis.length();
  double a = axis[0] / length;
