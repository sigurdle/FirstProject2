// LXWebSite.cpp : Implementation of DLL Exports.


// Note: Proxy/Stub Information
//      To build a separate proxy/stub DLL, 
//      run nmake -f LXWebSiteps.mk in the project directory.
...
OBJECT_ENTRY(CLSID_WebSite, CWebSite)
OBJECT_ENTRY(CLSID_LXWebSiteApp, CLXWebSiteApp)
OBJECT_ENTRY(CLSID_LXLocalWebSite, CLXLocalWebSite)
END_OBJECT_MAP()
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID /*lpReserved*/)
{
    ...
    {
        _Module.Init(ObjectMap, hInstance, &LIBID_LXWEBSITELib);
...
STDAPI DllRegisterServer(void)
{
	...
	if(SUCCEEDED(hr))
	{
...

		{
			...
			hr = pcr->RegisterClassImplCategories(CLSID_LXWebSiteApp, 1, rgcatid);
		}
