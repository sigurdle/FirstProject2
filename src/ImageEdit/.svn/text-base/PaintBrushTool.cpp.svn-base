...
// static
Gui::DependencyClass* ImageTool::get_Class()
{
	static Gui::DependencyClass Class(typeid(thisClass), baseClass::get_Class());
	return &Class;
}

IMP_DEPENDENCY_PROPERTY(float, PaintBrushTool, Size, 30.0f)
IMP_DEPENDENCY_PROPERTY(Gui::Color*, PaintBrushTool, Color, new Gui::Color(0.9f, 0.2f, 0))
IMP_DEPENDENCY_PROPERTY(float, PaintBrushTool, Opacity, 0.5f)
IMP_DEPENDENCY_PROPERTY(float, PaintBrushTool, Spacing, 0.15f)

// static
Gui::DependencyClass* PaintBrushTool::get_Class()
{
	static Gui::DependencyClass Class(typeid(thisClass), baseClass::get_Class());
...
PaintBrushTool::PaintBrushTool() : ImageTool(get_Class())
{
}

void PaintBrushTool::OnMouseDown(BitmapEditor* view, gm::PointF pos)
{
...
void PaintBrushTool::OnMouseUp(BitmapEditor* view, gm::PointF pos)
{
	if (view->get_HasMouseCapture())
	{
...
void PaintBrushTool::OnMouseMove(BitmapEditor* view, gm::PointF pos)
{
	if (view->get_HasMouseCapture())
	{
		StrokeVisual* topelement = dynamic_cast<StrokeVisual*>(view->m_topelement);
