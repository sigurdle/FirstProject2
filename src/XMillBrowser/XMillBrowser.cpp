// XMillBrowser.cpp : main source file for XMillBrowser.exe
//
...
//		run nmake -f XMillBrowserps.mk in the project directory.
#include "initguid.h"
#include "XMillBrowser.h"
#include "XMillBrowser_i.c"
