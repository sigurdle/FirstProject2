// LMathMLFencedElement.h : Declaration of the CLMathMLFencedElement

#ifndef __LMATHMLFENCEDELEMENT_H_
#define __LMATHMLFENCEDELEMENT_H_
...
class ATL_NO_VTABLE CLMathMLFencedElement : 
	public CComObjectRootEx<CComMultiThreadModel>,

	public CLMathMLElementImpl<CLMathMLFencedElement>,
//	public CLElementCSSInlineStyleImpl<CLMathMLFencedElement>,
//	public CLElementEditASImpl<CLMathMLFencedElement>,
	public CLElementEditVALImpl<CLMathMLFencedElement>,

	public ILMathMLFencedElement,
	public ILElementEditVAL,	// ILNodeEditVAL

	public CNotifyGetImpl<CLMathMLFencedElement>,
	public CNotifySendImpl<CLMathMLFencedElement>
{
public:

typedef CLMathMLFencedElement T;
	...
	int FinalConstruct()
	{
		...
		hr = CLMathMLElementImpl<CLMathMLFencedElement>::FinalConstruct();
		if (FAILED(hr)) return hr;

		//hr = CLElementCSSInlineStyleImpl<CLMathMLFencedElement>::FinalConstruct();
		//if (FAILED(hr)) return hr;
	...
	void FinalRelease()
	{
		//CLElementCSSInlineStyleImpl<CLMathMLFencedElement>::FinalRelease();
		CLMathMLElementImpl<CLMathMLFencedElement>::FinalRelease();
	}

//DECLARE_REGISTRY_RESOURCEID(IDR_LMathMLFencedElement)
DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CLMathMLFencedElement)
	COM_INTERFACE_ENTRY(ILDOMNode)
	COM_INTERFACE_ENTRY(ILDOMElement)
	COM_INTERFACE_ENTRY(ILMathMLElement)
	COM_INTERFACE_ENTRY(ILMathMLPresentationElement)
	COM_INTERFACE_ENTRY(ILMathMLPresentationContainer)
	COM_INTERFACE_ENTRY(ILMathMLFencedElement)
...
// ILMathMLFencedElement
public:
	STDMETHOD(get_open)(/*[out, retval]*/ BSTR *pVal);
	STDMETHOD(put_open)(/*[in]*/ BSTR newVal);
	STDMETHOD(get_close)(/*[out, retval]*/ BSTR *pVal);
	STDMETHOD(put_close)(/*[in]*/ BSTR newVal);
	STDMETHOD(get_separators)(/*[out, retval]*/ BSTR *pVal);
	STDMETHOD(put_separators)(/*[in]*/ BSTR newVal);
...
#endif //__LMATHMLFENCEDELEMENT_H_
