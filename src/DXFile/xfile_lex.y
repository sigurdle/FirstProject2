...
"\"".*"\""	{	PREFIX 
					...
					xfile_lval.pName = new ImmutableString<char>(string_copy(yytext+1, len-2));
					xfile_lval.pName->IncRef();
...
{ID}		{  PREFIX xfile_lval.pName = new ImmutableString<char>(string_copy(yytext)); return TOKEN_NAME;}
