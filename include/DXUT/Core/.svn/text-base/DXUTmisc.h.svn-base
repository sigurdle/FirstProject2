...
GUIEXT HRESULT DXUTGetGamepadState( DWORD dwPort, DXUT_GAMEPAD* pGamePad, bool bThumbstickDeadZone = true, bool bSnapThumbstickToCardinals = true );
GUIEXT HRESULT DXUTStopRumbleOnAllControllers();
GUIEXT void    DXUTEnableXInput( bool bEnable );
...
//--------------------------------------------------------------------------------------
GUIEXT LPCWSTR WINAPI DXUTD3DFormatToString( D3DFORMAT format, bool bWithPrefix );
...
//--------------------------------------------------------------------------------------
GUIEXT LPCWSTR WINAPI DXUTDXGIFormatToString( DXGI_FORMAT format, bool bWithPrefix );


//--------------------------------------------------------------------------------------
// Device settings conversion
//--------------------------------------------------------------------------------------
GUIEXT void WINAPI DXUTConvertDeviceSettings10to9( DXUTD3D10DeviceSettings* pIn, DXUTD3D9DeviceSettings* pOut );
GUIEXT void WINAPI DXUTConvertDeviceSettings9to10( DXUTD3D9DeviceSettings* pIn, DXUTD3D10DeviceSettings* pOut );
GUIEXT DXGI_FORMAT WINAPI ConvertFormatD3D9ToDXGI( D3DFORMAT fmt );
GUIEXT D3DFORMAT WINAPI ConvertFormatDXGIToD3D9( DXGI_FORMAT fmt );
...
GUIEXT HRESULT WINAPI DXUTTrace( const CHAR* strFile, DWORD dwLine, HRESULT hr, const WCHAR* strMsg, bool bPopMsgBox );
GUIEXT void WINAPI DXUTTraceDecl( D3DVERTEXELEMENT9 decl[MAX_FVF_DECL_SIZE] );
GUIEXT WCHAR* WINAPI DXUTTraceD3DDECLUSAGEtoString( BYTE u );
GUIEXT WCHAR* WINAPI DXUTTraceD3DDECLMETHODtoString( BYTE m );
GUIEXT WCHAR* WINAPI DXUTTraceD3DDECLTYPEtoString( BYTE t );
GUIEXT WCHAR* WINAPI DXUTTraceWindowsMessage( UINT uMsg );
...
GUIEXT IDirect3D9 * WINAPI DXUT_Dynamic_Direct3DCreate9(UINT SDKVersion);
GUIEXT int WINAPI DXUT_Dynamic_D3DPERF_BeginEvent( D3DCOLOR col, LPCWSTR wszName );
GUIEXT int WINAPI DXUT_Dynamic_D3DPERF_EndEvent( void );
GUIEXT void WINAPI DXUT_Dynamic_D3DPERF_SetMarker( D3DCOLOR col, LPCWSTR wszName );
GUIEXT void WINAPI DXUT_Dynamic_D3DPERF_SetRegion( D3DCOLOR col, LPCWSTR wszName );
GUIEXT BOOL WINAPI DXUT_Dynamic_D3DPERF_QueryRepeatFrame( void );
GUIEXT void WINAPI DXUT_Dynamic_D3DPERF_SetOptions( DWORD dwOptions );
GUIEXT DWORD WINAPI DXUT_Dynamic_D3DPERF_GetStatus( void );
GUIEXT HRESULT WINAPI DXUT_Dynamic_CreateDXGIFactory( REFIID rInterface, void ** ppOut );
GUIEXT HRESULT WINAPI DXUT_Dynamic_D3D10CreateDevice1( IDXGIAdapter *pAdapter,
...
GUIEXT HRESULT WINAPI DXUT_Dynamic_D3D10CreateDevice( IDXGIAdapter* pAdapter,
                                               D3D10_DRIVER_TYPE DriverType,
                                               HMODULE Software,
                                               UINT32 Flags,
...
GUIEXT HRESULT WINAPI DXUT_Dynamic_D3D10CreateStateBlock( ID3D10Device *pDevice, D3D10_STATE_BLOCK_MASK *pStateBlockMask, ID3D10StateBlock **ppStateBlock );
GUIEXT HRESULT WINAPI DXUT_Dynamic_D3D10StateBlockMaskUnion(D3D10_STATE_BLOCK_MASK *pA, D3D10_STATE_BLOCK_MASK *pB, D3D10_STATE_BLOCK_MASK *pResult);
GUIEXT HRESULT WINAPI DXUT_Dynamic_D3D10StateBlockMaskIntersect(D3D10_STATE_BLOCK_MASK *pA, D3D10_STATE_BLOCK_MASK *pB, D3D10_STATE_BLOCK_MASK *pResult);
GUIEXT HRESULT WINAPI DXUT_Dynamic_D3D10StateBlockMaskDifference(D3D10_STATE_BLOCK_MASK *pA, D3D10_STATE_BLOCK_MASK *pB, D3D10_STATE_BLOCK_MASK *pResult);
GUIEXT HRESULT WINAPI DXUT_Dynamic_D3D10StateBlockMaskEnableCapture(D3D10_STATE_BLOCK_MASK *pMask, D3D10_DEVICE_STATE_TYPES StateType, UINT RangeStart, UINT RangeLength);
GUIEXT HRESULT WINAPI DXUT_Dynamic_D3D10StateBlockMaskDisableCapture(D3D10_STATE_BLOCK_MASK *pMask, D3D10_DEVICE_STATE_TYPES StateType, UINT RangeStart, UINT RangeLength);
GUIEXT HRESULT WINAPI DXUT_Dynamic_D3D10StateBlockMaskEnableAll(D3D10_STATE_BLOCK_MASK *pMask);
GUIEXT HRESULT WINAPI DXUT_Dynamic_D3D10StateBlockMaskDisableAll(D3D10_STATE_BLOCK_MASK *pMask);
GUIEXT BOOL WINAPI DXUT_Dynamic_D3D10StateBlockMaskGetSetting(D3D10_STATE_BLOCK_MASK *pMask, D3D10_DEVICE_STATE_TYPES StateType, UINT Entry);
...
// the block ends.
//--------------------------------------------------------------------------------------
class GUIEXT CDXUTPerfEventGenerator
{
public:
...
GUIEXT HMONITOR WINAPI DXUTMonitorFromWindow( HWND hWnd, DWORD dwFlags );
GUIEXT HMONITOR WINAPI DXUTMonitorFromRect(LPCRECT lprcScreenCoords, DWORD dwFlags);
GUIEXT BOOL     WINAPI DXUTGetMonitorInfo( HMONITOR hMonitor, LPMONITORINFO lpMonitorInfo );
GUIEXT void     WINAPI DXUTGetDesktopResolution( UINT AdapterOrdinal, UINT* pWidth, UINT* pHeight );
...
// Release() when done with the device.
//--------------------------------------------------------------------------------------
GUIEXT ID3D10Device* WINAPI DXUTCreateRefDevice10( bool bNullRef = true );
