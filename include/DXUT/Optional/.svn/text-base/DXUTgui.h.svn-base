...
//-----------------------------------------------------------------------------
class GUIEXT CDXUTDialogResourceManager
{
public:
...
// Static control
//-----------------------------------------------------------------------------
class GUIEXT CDXUTStatic : public CDXUTControl
{
public:
...
// Button control
//-----------------------------------------------------------------------------
class GUIEXT CDXUTButton : public CDXUTStatic
{
public:
...
// CheckBox control
//-----------------------------------------------------------------------------
class GUIEXT CDXUTCheckBox : public CDXUTButton
{
public:
...
// RadioButton control
//-----------------------------------------------------------------------------
class GUIEXT CDXUTRadioButton : public CDXUTCheckBox
{
public:
...
// Scrollbar control
//-----------------------------------------------------------------------------
class GUIEXT CDXUTScrollBar : public CDXUTControl
{
public:
...
class GUIEXT CDXUTListBox : public CDXUTControl
{
public:
...
//template<> class GUIEXT CGrowableArray< DXUTComboBoxItem* >;

class GUIEXT CDXUTComboBox : public CDXUTButton
{
public:
...
// Slider control
//-----------------------------------------------------------------------------
class GUIEXT CDXUTSlider : public CDXUTControl
{
public:
...
// EditBox control
//-----------------------------------------------------------------------------
class GUIEXT CDXUTEditBox : public CDXUTControl
{
public:
