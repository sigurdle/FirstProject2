...
//--------------------------------------------------------------------------------------
class GUIEXT CFirstPersonCamera : public CBaseCamera
{
public:
    CFirstPersonCamera();
...
//--------------------------------------------------------------------------------------
class GUIEXT CModelViewerCamera : public CBaseCamera
{
public:
    CModelViewerCamera();
...
//--------------------------------------------------------------------------------------
class GUIEXT CDXUTDirectionWidget
{
public:
